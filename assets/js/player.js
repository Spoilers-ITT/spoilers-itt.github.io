public class OpenVoice {
    let now_playing = document.getElementById("podcastnav");
    ...
    //FullScren
    function fullScreen() {
        let eta = Math.floor((currentMinutes * 60) + currentSeconds);
        window.location.href = "fullscreen.html?episode=" + track_index;
    }
